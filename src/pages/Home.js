    ...
    return(
        <div className="home">
            <div className='navbar signbar'>
                ...
                <SignInButton><button className='buttons sign'>Sign In</button></SignInButton>
                <SignUpButton><button className='buttons sign'>Sign Up</button></SignUpButton>
            ...
            <div className="main-container">
                <div className="text-container">
                    ...
                    <SignUpButton><button className='buttons '>Try Now</button></SignUpButton>
                    </div>
                </div>
